...
const sharedCampaigns = [
  ...
  {
    id: 'lux-faerie-tale',
    image: '/images/Lux A Faerie Tale.png',
    tags: ['campaign', 'mystery']
  }
];
      ...
      const copy = ru
        ? [
            ...
            ['Первый спуск', 'Пролог / Подземье / Исследование / Детектив', 'Ваншот', 'Накануне крупнейшей экспедиции года герои прибывают в Моаргрим, чтобы пройти обязательный инструктаж для новичков. Вместе с другими участниками они отправляются в учебную пещеру, где опытный инструктор знакомит их с особенностями подземья, древними руинами и основами выживания в глубинах мира. Однако обычное обучение быстро принимает неожиданный оборот, когда группа сталкивается с вполне реальной угрозой. Инструктор уверяет, что всё происходящее является частью подготовки, но с каждым новым испытанием поверить в это становится всё сложнее.'],
              ...
              ['Лукс: Фейская сказка', 'Кампания / План Фей / Сказки / Опасные сделки', 'Кампания', 'Компания приключенцев отправляется по следу загадочного харенгона, но погоня неожиданно приводит их в План Фей — мир, где время течёт по собственным законам, каждое обещание становится магическим договором, а неверно сказанное слово может изменить судьбу. Оказавшись вдали от дома, герои оказываются втянуты в многовековое противостояние двух могущественных ведьм, каждая из которых стремится использовать чужаков в своей игре. Кому доверять, вмешаться ли в древнюю вражду или попытаться перехитрить обе стороны — решать предстоит самим игрокам. Приключение наполнено отсылками к классическим и народным сказкам, где знакомые мотивы переплетаются с фейской магией, странными правилами и опасными сделками. Но какой бы путь ни выбрали герои, главная задача остаётся неизменной — найти дорогу домой. Ведь выбраться из Плана Фей гораздо сложнее, чем попасть туда.']
          ]
        : [
            ...
            ['The First Descent', 'Prologue / Underdark / Exploration / Mystery', 'One-shot', 'On the eve of the largest expedition of the year, the heroes arrive in Moargrim to complete the mandatory training required for all new explorers. Alongside other recruits, they descend into a training cavern where a veteran instructor introduces them to the dangers of the Underdark, ancient ruins, and the skills needed to survive below. What begins as a routine exercise soon takes an unexpected turn when the group faces a very real threat. Their instructor insists that everything is part of the training program, but with each new challenge, that explanation becomes harder and harder to believe.'],
              ...
              ['Lux: A Faerie Tale', 'Campaign / Feywild / Fairy Tales / Dangerous Bargains', 'Campaign', 'A group of adventurers sets out in pursuit of a mysterious harengon, only to find themselves crossing into the Feywild — a realm where time follows its own rules, every promise becomes a binding pact, and a single careless word can alter fate. Far from home, the heroes are drawn into an age-old rivalry between two powerful witches, each determined to outwit the other and use the newcomers for her own ends. Whether to choose a side, challenge them both, or simply survive is entirely up to the players. Inspired by classic fairy tales and folklore, this adventure blends familiar stories with Fey magic, twisted bargains, and unpredictable rules. Whatever path the party takes, one goal never changes: finding a way home. Escaping the Feywild is far more difficult than entering it.']
          ];
